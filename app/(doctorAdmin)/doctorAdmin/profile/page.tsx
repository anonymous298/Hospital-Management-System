...
export default function DoctorProfilePage() {
  const [profile, setProfile] = useState<DoctorProfile>(INITIAL)
  const [draft,   setDraft  ] = useState<DoctorProfile>(INITIAL)
          ...
          <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-5">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-20 h-20 rounded-2xl overflow-hidden ring-4 ring-white/10">
                ...
                <img src={profile.clerkImage} alt={profile.name} className="w-full h-full object-cover" />
              </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-white/40 text-xs mt-1">{profile.clerkEmail}</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="flex items-center gap-2 bg-slate-50 border border-[#E5E7EB] rounded-xl px-4 py-2.5">
                  <p className="text-sm text-slate-500 flex-1">{profile.clerkEmail}</p>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 bg-slate-50 border border-[#E5E7EB] rounded-xl px-4 py-2">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={profile.clerkImage} alt="" className="w-7 h-7 rounded-lg object-cover" />
